                            ...
                            <div className="views-table">
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={8} style={{ textAlign: 'left' }}>
                                        <h3 style={{paddingLeft: "12px"}}>Views</h3>
                                    </Grid>
                                    <Grid item xs={4}>
                                ...
                                <TableContainer>
                                    <Table aria-label="simple table">
                                        <TableHead>
                                            <TableRow>
                                                <TableCell style={{ fontWeight: "600", opacity:"0.5" }}>Title</TableCell>
                                                <TableCell style={{ fontWeight: "600", opacity:"0.5" }} align="right">Count</TableCell>
                                            </TableRow>
                                        </TableHead>
                                        <TableBody>
                                            {tableData.map((row) => (
